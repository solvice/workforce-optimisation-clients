...
import six
from swagger_client.models.demand_shift import DemandShift  # noqa: F401,E501
...
class Demand(object):
    ...
    def __init__(self, shift=None, skill=None, pref_demand=None):  # noqa: E501
        """Demand - a model defined in Swagger"""  # noqa: E501
        self._shift = None
        self._skill = None
        self._pref_demand = None
        self.discriminator = None
        self.shift = shift
        self.skill = skill
        self.pref_demand = pref_demand

    @property
    def shift(self):
        """Gets the shift of this Demand.  # noqa: E501


        :return: The shift of this Demand.  # noqa: E501
        :rtype: DemandShift
        """
        return self._shift
    ...
    def shift(self, shift):
        """Sets the shift of this Demand.


        :param shift: The shift of this Demand.  # noqa: E501
        :type: DemandShift
        """
        if shift is None:
            raise ValueError("Invalid value for `shift`, must not be `None`")  # noqa: E501

        self._shift = shift

    @property
    def skill(self):
        """Gets the skill of this Demand.  # noqa: E501

        Skill type definition  # noqa: E501

        :return: The skill of this Demand.  # noqa: E501
        :rtype: str
        """
        return self._skill
    ...
    def skill(self, skill):
        """Sets the skill of this Demand.

        Skill type definition  # noqa: E501

        :param skill: The skill of this Demand.  # noqa: E501
        :type: str
        """
        if skill is None:
    ...
    @property
    def pref_demand(self):
        """Gets the pref_demand of this Demand.  # noqa: E501

        The number of employees of that skill to be present.  # noqa: E501

        :return: The pref_demand of this Demand.  # noqa: E501
        :rtype: int
        """
        return self._pref_demand

    @pref_demand.setter
    def pref_demand(self, pref_demand):
        """Sets the pref_demand of this Demand.

        The number of employees of that skill to be present.  # noqa: E501

        :param pref_demand: The pref_demand of this Demand.  # noqa: E501
        :type: int
        """
        if pref_demand is None:
            raise ValueError("Invalid value for `pref_demand`, must not be `None`")  # noqa: E501

        self._pref_demand = pref_demand
