...
class BlockAssignment(object):
    ...
    def __init__(self, _date=None, index=None):  # noqa: E501
        """BlockAssignment - a model defined in Swagger"""  # noqa: E501
        self.__date = None
        self._index = None
    ...
    @property
    def _date(self):
        """Gets the _date of this BlockAssignment.  # noqa: E501

        Date of the assignment  # noqa: E501

        :return: The _date of this BlockAssignment.  # noqa: E501
        :rtype: date
        """
        return self.__date
    ...
    def _date(self, _date):
        """Sets the _date of this BlockAssignment.

        Date of the assignment  # noqa: E501

        :param _date: The _date of this BlockAssignment.  # noqa: E501
        :type: date
        """
    ...
    @property
    def index(self):
        """Gets the index of this BlockAssignment.  # noqa: E501

        Index number of the block  # noqa: E501

        :return: The index of this BlockAssignment.  # noqa: E501
        :rtype: int
        """
        return self._index
    ...
    def index(self, index):
        """Sets the index of this BlockAssignment.

        Index number of the block  # noqa: E501

        :param index: The index of this BlockAssignment.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BlockAssignment, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BlockAssignment):
            return False
