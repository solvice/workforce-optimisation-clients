...
class SolveJob(object):
    ...
    def __init__(self, solver=None, hook=None):  # noqa: E501
        """SolveJob - a model defined in Swagger"""  # noqa: E501
        self._solver = None
        self._hook = None
    ...
    @property
    def solver(self):
        """Gets the solver of this SolveJob.  # noqa: E501


        :return: The solver of this SolveJob.  # noqa: E501
        :rtype: Solver
        """
        return self._solver
    ...
    def solver(self, solver):
        """Sets the solver of this SolveJob.


        :param solver: The solver of this SolveJob.  # noqa: E501
        :type: Solver
        """
    ...
    @property
    def hook(self):
        """Gets the hook of this SolveJob.  # noqa: E501

        Webhook returns solution status after solving in the form of a POST request to the uri given.  # noqa: E501

        :return: The hook of this SolveJob.  # noqa: E501
        :rtype: str
        """
        return self._hook
    ...
    @hook.setter
    def hook(self, hook):
        """Sets the hook of this SolveJob.

        Webhook returns solution status after solving in the form of a POST request to the uri given.  # noqa: E501

        :param hook: The hook of this SolveJob.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SolveJob):
            return False
