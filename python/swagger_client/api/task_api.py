...
class TaskApi(object):
    ...
    def solve_task(self, **kwargs):  # noqa: E501
        """Solve TASK problem  # noqa: E501

        Solving task optimisation problem   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.solve_task(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int seconds: The number of seconds you give the solver to optimise the TASK problem. By default, the solver decides.
        :return: StatusJob
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.solve_task_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.solve_task_with_http_info(**kwargs)  # noqa: E501
            return data

    def solve_task_with_http_info(self, **kwargs):  # noqa: E501
        """Solve TASK problem  # noqa: E501

        Solving task optimisation problem   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.solve_task_with_http_info(async_req=True)
        >>> result = thread.get()
