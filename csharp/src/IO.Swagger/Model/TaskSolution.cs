...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TaskSolution : SolutionJob,  IEquatable<TaskSolution>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TaskSolution" /> class.
        /// </summary>
        /// <param name="">.</param>
        public TaskSolution(Object  = default(Object), JobId  = default(JobId), Solver?  = default(Solver?), Status?  = default(Status?)) : base(, , )
        {
            this.Solution = ;
        }
        ...
        {
            return this.Equals(input as TaskSolution);
        }

        /// <summary>
        /// Returns true if TaskSolution instances are equal
        /// </summary>
        /// <param name="input">Instance of TaskSolution to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TaskSolution input)
        {
            if (input == null)
                return false;
