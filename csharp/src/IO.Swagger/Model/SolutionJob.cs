...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SolutionJob :  IEquatable<SolutionJob>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Solver
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SolutionJob" /> class.
        /// </summary>
        /// <param name="">.</param>
        /// <param name="">.</param>
        /// <param name="">.</param>
        public SolutionJob(JobId  = default(JobId), Solver?  = default(Solver?), Status?  = default(Status?))
        {
            this.Id = ;
            this.Solver = ;
            this.Status = ;
        ...
        {
            return this.Equals(input as SolutionJob);
        }

        /// <summary>
        /// Returns true if SolutionJob instances are equal
        /// </summary>
        /// <param name="input">Instance of SolutionJob to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SolutionJob input)
        {
            if (input == null)
                return false;
