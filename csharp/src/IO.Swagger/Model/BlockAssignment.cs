...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BlockAssignment :  IEquatable<BlockAssignment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockAssignment" /> class.
        /// </summary>
        /// <param name="">Date of the assignment.</param>
        /// <param name="">Index number of the block.</param>
        public BlockAssignment(DateTime?  = default(DateTime?), int?  = default(int?))
        {
            this.Date = ;
            this.Index = ;
        }
        ...
        /// </summary>
        /// <value>Index number of the block</value>
        ...
        {
            return this.Equals(input as BlockAssignment);
        }

        /// <summary>
        /// Returns true if BlockAssignment instances are equal
        /// </summary>
        /// <param name="input">Instance of BlockAssignment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlockAssignment input)
        {
            if (input == null)
                return false;
