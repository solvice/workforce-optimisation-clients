...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SolveJob :  IEquatable<SolveJob>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Solver
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SolveJob" /> class.
        /// </summary>
        /// <param name="">.</param>
        /// <param name="">Webhook returns solution status after solving in the form of a POST request to the uri given..</param>
        public SolveJob(Solver?  = default(Solver?), string  = default(string))
        {
            this.Solver = ;
            this.Hook = ;
        }
        ...
        /// </summary>
        /// <value>Webhook returns solution status after solving in the form of a POST request to the uri given.</value>
        ...
        {
            return this.Equals(input as SolveJob);
        }

        /// <summary>
        /// Returns true if SolveJob instances are equal
        /// </summary>
        /// <param name="input">Instance of SolveJob to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SolveJob input)
        {
            if (input == null)
                return false;
