...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
        public interface ITaskAPIApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
        public partial class TaskAPIApi : ITaskAPIApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="TaskAPIApi"/> class.
        /// </summary>
        /// <returns></returns>
        public TaskAPIApi(String basePath)
        {
        ...
        /// <returns></returns>
        public TaskAPIApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> GetSolutionWithHttpInfo (Guid? jobId)
        {
            ...
            if (jobId == null)
                throw new ApiException(400, "Missing required parameter 'jobId' when calling TaskAPIApi->GetSolution");
        ...
        public ApiResponse< StatusJob > GetStatusWithHttpInfo (Guid? jobId)
        {
            // verify the required parameter 'jobId' is set
            if (jobId == null)
                throw new ApiException(400, "Missing required parameter 'jobId' when calling TaskAPIApi->GetStatus");
