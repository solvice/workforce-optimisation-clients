...
'last_rest_date' => 'setLastRestDate'    ];
...
'last_rest_date' => 'getLastRestDate'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['hourly_pay'] = isset($data['hourly_pay']) ? $data['hourly_pay'] : null;
        $this->container['last_rest_date'] = isset($data['last_rest_date']) ? $data['last_rest_date'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['statute'] === null) {
            $invalidProperties[] = "'statute' can't be null";
        }
     ...
     * Sets name
     *
     * @param string $name Unique name/id of employee
     *
     * @return $this
     */
     ...
     * Sets statute
     *
     * @param string $statute Reference to Statute name
     *
     * @return $this
     */
     ...
     * Sets skill
     *
     * @param string $skill Skill name owned by employee
     *
     * @return $this
     */
     ...
     * Sets efficiency
     *
     * @param BigDecimal $efficiency Efficiency rate of employee. 1.0 is normal and default
     *
     * @return $this
     */
     ...
     * Sets hourly_pay
     *
     * @param BigDecimal $hourly_pay Hourly wage/pay for employee. Total costs are minimised by the optimiser.
     *
     * @return $this
     */
     ...
     * @return \DateTime
     */
    public function getLastRestDate()
    {
        return $this->container['last_rest_date'];
    }

    /**
     * Sets last_rest_date
     *
     * @param \DateTime $last_rest_date The last date on which the employee had a rest before the planning period.
     *
     * @return $this
     */
    public function setLastRestDate($last_rest_date)
    {
        $this->container['last_rest_date'] = $last_rest_date;
